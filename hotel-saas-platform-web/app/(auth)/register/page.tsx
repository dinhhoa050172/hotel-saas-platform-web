...
export const metadata: Metadata = {
  title: "Đăng ký | HotelSaaS",
  description: "Tạo tài khoản để đặt phòng và khám phá hàng ngàn khách sạn",
};
  ...
  return (
    <main className="min-h-screen bg-white flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-slate-900 to-slate-800 items-center justify-center p-16">
        <div className="absolute inset-0 bg-[url('/images/landing_3.jpg')] bg-cover bg-center opacity-30" />
        <div className="relative z-10 text-white text-center max-w-md">
          ...
          <p className="mt-4 text-white/70 text-base leading-relaxed">
            Tham gia cộng đồng hàng triệu du khách và chủ nhà trên khắp Việt
            Nam.
          </p>
        </div>
      </div>
